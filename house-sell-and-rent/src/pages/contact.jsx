...
function Contact() {
  return (
    <div className="flex h-screen w-full flex-col">
      <h1 className=" mx-40 mt-36 md:mb-0 md:mt-3 md:mx-10 text-4xl font-serif font-bold md:2xl">
        CONTACTS
      </h1>

      <div className="grid md:grid-cols-1 w-full  grid-cols-2 ">
        <div>
          <div className="w-1/2  md:w-full md:mx-0  mx-20 ">
            <div className=" bg-slate-700 p-2 my-6 md:my-0 rounded-lg  flex justify-start justify-items-center  grid-cols-2">
              ...
              <div className="mx-1 font-serif text-white">
